                ...
                return `
                    <div class="glass rounded-3xl overflow-hidden group border border-white/5 hover:border-orange-500/40 transition duration-300">
                        <div class="relative h-48 overflow-hidden">
                            ${img ? `<img src="${escapeHtml(img)}" loading="lazy" decoding="async" width="400" height="192" class="w-full h-full object-cover group-hover:scale-105 transition duration-500" alt="${name} certificate from ${org}">` : '<div class="w-full h-full bg-white/5 flex items-center justify-center text-gray-500 text-xs">Certificate image unavailable</div>'}
